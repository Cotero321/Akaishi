...
public interface ClientScreenInputEvent {
    /**
     * @see MouseScrolled#mouseScrolled(class_310, class_437, double, double, double)
     */
    ...
    /**
     * @see MouseClicked#mouseClicked(class_310, class_437, double, double, int)
     */
    ...
    /**
     * @see MouseReleased#mouseReleased(class_310, class_437, double, double, int)
     */
    ...
    /**
     * @see MouseDragged#mouseDragged(class_310, class_437, double, double, int, double, double)
     */
    ...
    /**
     * @see KeyTyped#charTyped(class_310, class_437, char, int)
     */
    ...
    /**
     * @see KeyPressed#keyPressed(class_310, class_437, int, int, int)
     */
    ...
    /**
     * @see KeyReleased#keyReleased(class_310, class_437, int, int, int)
     */
    ...
    interface KeyPressed {
         ...
         */
        EventResult keyPressed(class_310 client, class_437 screen, int keyCode, int scanCode, int modifiers);
    }
    ...
    interface KeyReleased {
         ...
         */
        EventResult keyReleased(class_310 client, class_437 screen, int keyCode, int scanCode, int modifiers);
    }
    ...
    interface KeyTyped {
         ...
         */
        EventResult charTyped(class_310 client, class_437 screen, char character, int keyCode);
    }
    ...
    interface MouseScrolled {
         ...
         */
        EventResult mouseScrolled(class_310 client, class_437 screen, double mouseX, double mouseY, double amount);
    }
    ...
    interface MouseReleased {
         ...
         * the execution of the vanilla releasing mechanism may be cancelled by the result.
         */
        EventResult mouseReleased(class_310 client, class_437 screen, double mouseX, double mouseY, int button);
    }
    ...
    interface MouseDragged {
         ...
         */
        EventResult mouseDragged(class_310 client, class_437 screen, double mouseX1, double mouseY1, int button, double mouseX2, double mouseY2);
    }
    ...
    interface MouseClicked {
         ...
         */
        EventResult mouseClicked(class_310 client, class_437 screen, double mouseX, double mouseY, int button);
    }
}
