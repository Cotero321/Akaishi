...
public interface ClientChatEvent {
    /**
     * @see Send#send(String, class_2561)
     */
    Event<Send> SEND = EventFactory.createEventResult();
    /**
     * @see Received#process(class_2556.class_7602, class_2561)
     */
    ...
    interface Send {
         ...
         */
        EventResult send(String message, @Nullable class_2561 component);
    }
    ...
    interface Received {
         ...
         */
        CompoundEventResult<class_2561> process(class_2556.class_7602 type, class_2561 message);
    }
}
