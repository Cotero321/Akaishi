...
public interface ClientRawInputEvent {
    /**
     * @see MouseScrolled#mouseScrolled(class_310, double)
     */
    Event<MouseScrolled> MOUSE_SCROLLED = EventFactory.createEventResult();
    /**
     * @see MouseClicked#mouseClicked(class_310, int, int, int)
     */
    ...
    /**
     * @see KeyPressed#keyPressed(class_310, int, int, int, int)
     */
    ...
    interface KeyPressed {
         ...
         */
        EventResult keyPressed(class_310 client, int keyCode, int scanCode, int action, int modifiers);
    }
    ...
    interface MouseScrolled {
         ...
         */
        EventResult mouseScrolled(class_310 client, double amount);
    }
    ...
    interface MouseClicked {
         ...
         */
        EventResult mouseClicked(class_310 client, int button, int action, int mods);
    }
}
