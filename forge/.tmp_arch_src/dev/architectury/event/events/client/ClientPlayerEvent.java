...
public interface ClientPlayerEvent {
    ...
    interface ClientPlayerQuit {
         ...
         */
        void quit(@Nullable class_746 player);
    }
    ...
    interface ClientPlayerRespawn {
         ...
         */
        void respawn(class_746 oldPlayer, class_746 newPlayer);
    }
}
