...
public interface EntityEvent {
    /**
     * @see LivingDeath#die(class_1309, class_1282)
     */
    Event<LivingDeath> LIVING_DEATH = EventFactory.createEventResult();
    /**
     * @see LivingHurt#hurt(class_1309, class_1282, float)
     */
    Event<LivingHurt> LIVING_HURT = EventFactory.createEventResult();
    /**
     * @see LivingCheckSpawn#canSpawn(class_1309, class_1936, double, double, double, class_3730, class_1917)
     */
    Event<LivingCheckSpawn> LIVING_CHECK_SPAWN = EventFactory.createEventResult();
    /**
     * @see Add#add(class_1297, class_1937)
     */
    Event<Add> ADD = EventFactory.createEventResult();
    /**
     * @see EnterSection#enterSection(class_1297, int, int, int, int, int, int)
     */
    Event<EnterSection> ENTER_SECTION = EventFactory.createLoop();
    /**
     * @see AnimalTame#tame(class_1429, class_1657)
     */
    ...
    interface LivingDeath {
         ...
         */
        EventResult die(class_1309 entity, class_1282 source);
    }
    ...
    interface LivingHurt {
         ...
         */
        EventResult hurt(class_1309 entity, class_1282 source, float amount);
    }
    
    interface LivingCheckSpawn {
        /**
         * Invoked before an entity is spawned into the world.
         * This specifically concerns <i>spawning</i> through either a {@link class_1917} or during world generation.
         ...
         * @return A {@link class_1271} determining the outcome of the event,
         * if an outcome is set, the vanilla result is overridden.
         */
        EventResult canSpawn(class_1309 entity, class_1936 world, double x, double y, double z, class_3730 type, @Nullable class_1917 spawner);
    }
    ...
    interface Add {
         ...
         */
        EventResult add(class_1297 entity, class_1937 world);
    }
    ...
    interface EnterSection {
         ...
         */
        void enterSection(class_1297 entity, int sectionX, int sectionY, int sectionZ, int prevX, int prevY, int prevZ);
    }
    ...
    interface AnimalTame {
         ...
         */
        EventResult tame(class_1429 animal, class_1657 player);
    }
}
