...
public interface LootEvent {
     ...
     * }</pre>
     *
     * @see ModifyLootTable#modifyLootTable(class_60, class_2960, LootTableModificationContext, boolean)
     */
    ...
    interface ModifyLootTable {
         ...
         *
         * @param lootDataManager the {@link class_60} instance containing all loot tables,
         *                        may be {@code null}
         ...
         */
        void modifyLootTable(@Nullable class_60 lootDataManager, class_2960 id, LootTableModificationContext context, boolean builtin);
    }
    ...
    interface LootTableModificationContext {
         ...
         * @param pool the pool to add
         */
        default void addPool(class_55.class_56 pool) {
            addPool(pool.method_355());
        }
    }
}
