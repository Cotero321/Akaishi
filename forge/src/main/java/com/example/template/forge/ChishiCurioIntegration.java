...
import com.example.template.item.curio.ChishiCurioItem;
 ...
 */
public final class ChishiCurioIntegration {

    public static final ChishiCurioIntegration INSTANCE = new ChishiCurioIntegration();

    private ChishiCurioIntegration() {
    }
    ...
    public void onLivingDrops(LivingDropsEvent event) {
        if (event.getSource().getEntity() instanceof Player player) {
            forEachCurio(player, stack -> {
                if (stack.getItem() instanceof ChishiCurioItem curio) {
