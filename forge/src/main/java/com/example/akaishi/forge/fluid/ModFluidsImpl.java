...
public final class ModFluidsImpl {
    ...
    public static final DeferredRegister<Fluid> FLUIDS =
            DeferredRegister.create(ForgeRegistries.FLUIDS, AkaishiMod.MOD_ID);
    ...
    private static SimpleArchitecturyFluidAttributes netherPureEnergyAttrs() {
        if (netherPureEnergyAttrs == null) {
            netherPureEnergyAttrs = SimpleArchitecturyFluidAttributes.ofSupplier(() -> NETHER_PURE_ENERGY_FLOWING, () -> NETHER_PURE_ENERGY)
                    ...
                    .sourceTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/nether_pure_energy_still"))
                    .flowingTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/nether_pure_energy_flow"));
        }
    ...
    private static SimpleArchitecturyFluidAttributes netherCompoundEnergyAttrs() {
        if (netherCompoundEnergyAttrs == null) {
            netherCompoundEnergyAttrs = SimpleArchitecturyFluidAttributes.ofSupplier(() -> NETHER_COMPOUND_ENERGY_FLOWING, () -> NETHER_COMPOUND_ENERGY)
                    ...
                    .sourceTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/nether_compound_energy_still"))
                    .flowingTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/nether_compound_energy_flow"));
        }
    ...
    private static SimpleArchitecturyFluidAttributes pureFuelAttrs() {
        if (pureFuelAttrs == null) {
            pureFuelAttrs = SimpleArchitecturyFluidAttributes.ofSupplier(() -> PURE_FUEL_FLOWING, () -> PURE_FUEL)
                    ...
                    .sourceTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/pure_fuel_still"))
                    .flowingTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/pure_fuel_flow"));
        }
    ...
    private static SimpleArchitecturyFluidAttributes netherCompoundFuelAttrs() {
        if (netherCompoundFuelAttrs == null) {
            netherCompoundFuelAttrs = SimpleArchitecturyFluidAttributes.ofSupplier(() -> NETHER_COMPOUND_FUEL_FLOWING, () -> NETHER_COMPOUND_FUEL)
                    ...
                    .sourceTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/nether_compound_fuel_still"))
                    .flowingTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/nether_compound_fuel_flow"));
        }
    ...
    private static SimpleArchitecturyFluidAttributes advancedMixtureFuelAttrs() {
        if (advancedMixtureFuelAttrs == null) {
            advancedMixtureFuelAttrs = SimpleArchitecturyFluidAttributes.ofSupplier(() -> ADVANCED_MIXTURE_FUEL_FLOWING, () -> ADVANCED_MIXTURE_FUEL)
                    ...
                    .sourceTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/advanced_mixture_fuel_still"))
                    .flowingTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/advanced_mixture_fuel_flow"));
        }
    ...
    private static SimpleArchitecturyFluidAttributes ultimateMixtureFuelAttrs() {
        if (ultimateMixtureFuelAttrs == null) {
            ultimateMixtureFuelAttrs = SimpleArchitecturyFluidAttributes.ofSupplier(() -> ULTIMATE_MIXTURE_FUEL_FLOWING, () -> ULTIMATE_MIXTURE_FUEL)
                    ...
                    .sourceTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/ultimate_mixture_fuel_still"))
                    .flowingTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/ultimate_mixture_fuel_flow"));
        }
    ...
    private static SimpleArchitecturyFluidAttributes endMixtureFuelAttrs() {
        if (endMixtureFuelAttrs == null) {
            endMixtureFuelAttrs = SimpleArchitecturyFluidAttributes.ofSupplier(() -> END_MIXTURE_FUEL_FLOWING, () -> END_MIXTURE_FUEL)
                    ...
                    .sourceTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/end_mixture_fuel_still"))
                    .flowingTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/end_mixture_fuel_flow"));
        }
    ...
    private static SimpleArchitecturyFluidAttributes dragonFuelAttrs() {
        if (dragonFuelAttrs == null) {
            dragonFuelAttrs = SimpleArchitecturyFluidAttributes.ofSupplier(() -> DRAGON_FUEL_FLOWING, () -> DRAGON_FUEL)
                    ...
                    .sourceTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/dragon_fuel_still"))
                    .flowingTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/dragon_fuel_flow"));
        }
    ...
    private static SimpleArchitecturyFluidAttributes sculkLifeFuelAttrs() {
        if (sculkLifeFuelAttrs == null) {
            sculkLifeFuelAttrs = SimpleArchitecturyFluidAttributes.ofSupplier(() -> SCULK_LIFE_FUEL_FLOWING, () -> SCULK_LIFE_FUEL)
                    ...
                    .sourceTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/sculk_life_fuel_still"))
                    .flowingTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/sculk_life_fuel_flow"));
        }
    ...
    private static SimpleArchitecturyFluidAttributes exhaustedAttrs(Supplier<RegistryObject<Fluid>> flowing, Supplier<RegistryObject<Fluid>> source, int color) {
        return SimpleArchitecturyFluidAttributes.ofSupplier(flowing, source)
                ...
                .sourceTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/exhausted_life_fuel_still"))
                .flowingTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/exhausted_life_fuel_flow"));
    }
    ...
    private static SimpleArchitecturyFluidAttributes activatedAttrs(Supplier<RegistryObject<Fluid>> flowing, Supplier<RegistryObject<Fluid>> source, int color) {
        return SimpleArchitecturyFluidAttributes.ofSupplier(flowing, source)
                ...
                .sourceTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/activated_life_fuel_still"))
                .flowingTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/activated_life_fuel_flow"));
    }
    ...
    // ===== 等离子体（3 种）：聚变燃料聚合器产物（共用等离子体贴图 + 各自着色，高温强光轻质） =====

    /** 统一构建等离子体 attributes：物理属性一致，仅颜色区分 */
    private static SimpleArchitecturyFluidAttributes plasmaAttrs(Supplier<RegistryObject<Fluid>> flowing, Supplier<RegistryObject<Fluid>> source, int color) {
        return SimpleArchitecturyFluidAttributes.ofSupplier(flowing, source)
                .color(color)
                .density(-500).viscosity(800).temperature(100000).luminosity(15)
                .sourceTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/plasma_still"))
                .flowingTexture(new ResourceLocation(AkaishiMod.MOD_ID, "block/fluid/plasma_flow"));
    }

    private static SimpleArchitecturyFluidAttributes mixedPlasmaAttrs;

    private static SimpleArchitecturyFluidAttributes mixedPlasmaAttrs() {
        if (mixedPlasmaAttrs == null) {
            mixedPlasmaAttrs = plasmaAttrs(() -> MIXED_PLASMA_FLOWING, () -> MIXED_PLASMA, ModFluids.COLOR_MIXED_PLASMA);
        }
        return mixedPlasmaAttrs;
    }

    private static SimpleArchitecturyFluidAttributes netherPlasmaAttrs;

    private static SimpleArchitecturyFluidAttributes netherPlasmaAttrs() {
        if (netherPlasmaAttrs == null) {
            netherPlasmaAttrs = plasmaAttrs(() -> NETHER_PLASMA_FLOWING, () -> NETHER_PLASMA, ModFluids.COLOR_NETHER_PLASMA);
        }
        return netherPlasmaAttrs;
    }

    private static SimpleArchitecturyFluidAttributes endPlasmaAttrs;

    private static SimpleArchitecturyFluidAttributes endPlasmaAttrs() {
        if (endPlasmaAttrs == null) {
            endPlasmaAttrs = plasmaAttrs(() -> END_PLASMA_FLOWING, () -> END_PLASMA, ModFluids.COLOR_END_PLASMA);
        }
        return endPlasmaAttrs;
    }

    public static final RegistryObject<Fluid> MIXED_PLASMA =
            FLUIDS.register(ModFluids.MIXED_PLASMA_ID, () -> new ArchitecturyFlowingFluid.Source(mixedPlasmaAttrs()));
    public static final RegistryObject<Fluid> MIXED_PLASMA_FLOWING =
            FLUIDS.register(ModFluids.MIXED_PLASMA_ID + "_flowing", () -> new ArchitecturyFlowingFluid.Flowing(mixedPlasmaAttrs()));

    public static final RegistryObject<Fluid> NETHER_PLASMA =
            FLUIDS.register(ModFluids.NETHER_PLASMA_ID, () -> new ArchitecturyFlowingFluid.Source(netherPlasmaAttrs()));
    public static final RegistryObject<Fluid> NETHER_PLASMA_FLOWING =
            FLUIDS.register(ModFluids.NETHER_PLASMA_ID + "_flowing", () -> new ArchitecturyFlowingFluid.Flowing(netherPlasmaAttrs()));

    public static final RegistryObject<Fluid> END_PLASMA =
            FLUIDS.register(ModFluids.END_PLASMA_ID, () -> new ArchitecturyFlowingFluid.Source(endPlasmaAttrs()));
    public static final RegistryObject<Fluid> END_PLASMA_FLOWING =
            FLUIDS.register(ModFluids.END_PLASMA_ID + "_flowing", () -> new ArchitecturyFlowingFluid.Flowing(endPlasmaAttrs()));
