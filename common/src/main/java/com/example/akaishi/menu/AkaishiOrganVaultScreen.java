 ...
 */
public class AkaishiOrganVaultScreen extends AbstractContainerScreen<AkaishiOrganVaultMenu> {
    ...
    public AkaishiOrganVaultScreen(AkaishiOrganVaultMenu menu, Inventory inv, Component title) {
    ...
    protected void renderBg(GuiGraphics gui, float partialTick, int mouseX, int mouseY) {
        ...
        // 页按钮（1-9，选中高亮）
        for (int i = 0; i < AkaishiOrganVaultBlockEntity.PAGE_COUNT; i++) {
    ...
    protected void renderLabels(GuiGraphics gui, int mouseX, int mouseY) {
        ...
        gui.drawString(this.font,
                Component.translatable(menu.isActive()
                        ? "gui.akaishi.organ_vault.active"
                        : "gui.akaishi.organ_vault.dormant"),
