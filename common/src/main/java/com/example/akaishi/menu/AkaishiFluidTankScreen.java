...
/**
 * 液体储罐界面：单一液体量条（青）+ 数值文本。
 * 数据来自 {@link AkaishiFluidTankMenu} 的 ContainerData。
 */
public class AkaishiFluidTankScreen extends AbstractContainerScreen<AkaishiFluidTankMenu> {
    ...
    public AkaishiFluidTankScreen(AkaishiFluidTankMenu menu, Inventory inv, Component title) {
