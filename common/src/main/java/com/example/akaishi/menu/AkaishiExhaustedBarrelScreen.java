 ...
 * 数据来自 {@link AkaishiExhaustedBarrelMenu} 的 ContainerData。
 */
public class AkaishiExhaustedBarrelScreen extends AbstractContainerScreen<AkaishiExhaustedBarrelMenu> {
    ...
    public AkaishiExhaustedBarrelScreen(AkaishiExhaustedBarrelMenu menu, Inventory inv, Component title) {
    ...
    public void render(GuiGraphics gui, int mouseX, int mouseY, float partialTick) {
        ...
        if (isHovering(BAR_X, BAR_Y, BAR_W, BAR_H, mouseX, mouseY)) {
            gui.renderTooltip(this.font,
                    Component.translatable("gui.akaishi.fluid", amount, max),
                    mouseX, mouseY);
        }
    }
}
