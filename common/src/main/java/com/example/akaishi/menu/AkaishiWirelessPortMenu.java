 ...
 */
public class AkaishiWirelessPortMenu extends AbstractContainerMenu implements AkaishiPortBindingSync.Target {
    ...
    private List<AkaishiPortBindingSync.Entry> buildBindingEntries() {
        ...
        for (WirelessNetworkManager.TerminalEntry entry : WirelessNetworkManager.bindableTerminals(
                WirelessFamily.CHISHI, this.player.getUUID())) {
     ...
     * 否则路人右键一次就能把别人的物流改投到自己终端，或直接解绑让别人的口失效。
     */
