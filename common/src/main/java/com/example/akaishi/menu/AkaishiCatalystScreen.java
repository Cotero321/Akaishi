 ...
 * 无机器槽位；数据来自 {@link AkaishiCatalystMenu} 的 ContainerData，随网络同步。
 */
public class AkaishiCatalystScreen extends AbstractContainerScreen<AkaishiCatalystMenu> {
    ...
    public AkaishiCatalystScreen(AkaishiCatalystMenu menu, Inventory inv, Component title) {
    ...
    protected void renderLabels(GuiGraphics gui, int mouseX, int mouseY) {
        ...
        gui.drawString(this.font, Component.translatable(working
                        ? "gui.akaishi.catalyst.working" : "gui.akaishi.catalyst.idle"),
