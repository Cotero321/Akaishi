 ...
 */
public class AkaishiWirelessPortableTerminalScreen extends AbstractContainerScreen<AkaishiWirelessPortableTerminalMenu> {
    ...
    public AkaishiWirelessPortableTerminalScreen(AkaishiWirelessPortableTerminalMenu menu, Inventory inv, Component title) {
