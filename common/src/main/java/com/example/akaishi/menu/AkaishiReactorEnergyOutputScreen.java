 ...
 * 数值以 K/M/B/T 单位缩写显示，数据来自 {@link AkaishiReactorEnergyOutputMenu} 的 ContainerData。
 */
public class AkaishiReactorEnergyOutputScreen extends AbstractContainerScreen<AkaishiReactorEnergyOutputMenu> {
    ...
    public AkaishiReactorEnergyOutputScreen(AkaishiReactorEnergyOutputMenu menu, Inventory inv, Component title) {
