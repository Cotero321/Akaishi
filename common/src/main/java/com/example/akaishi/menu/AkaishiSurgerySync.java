 ...
 */
public final class AkaishiSurgerySync {

    public static final ResourceLocation CHANNEL = new ResourceLocation(AkaishiMod.MOD_ID, "surgery_start");

    private AkaishiSurgerySync() {
    }
    ...
    public static void register() {
        NetworkManager.registerReceiver(NetworkManager.Side.C2S, CHANNEL, (buf, context) -> {
            ...
            context.queue(() -> {
                ...
                if (player != null && player.level().getBlockEntity(pos) instanceof AkaishiSurgeryBlockEntity be) {
