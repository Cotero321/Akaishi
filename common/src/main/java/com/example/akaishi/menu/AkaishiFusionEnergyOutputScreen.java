...
/**
 * 聚变能量输出口界面：赤能源缓冲条 + 数值信息 + 纯发电提示，无机器槽位。
 * 数值以 K/M/B/T 单位缩写显示，数据来自 {@link AkaishiFusionEnergyOutputMenu} 的 ContainerData。
 */
public class AkaishiFusionEnergyOutputScreen extends AbstractContainerScreen<AkaishiFusionEnergyOutputMenu> {
    ...
    public AkaishiFusionEnergyOutputScreen(AkaishiFusionEnergyOutputMenu menu, Inventory inv, Component title) {
    ...
    public void render(GuiGraphics gui, int mouseX, int mouseY, float partialTick) {
        ...
        // 纯发电提示（缓冲槽说明）
        Component hint = Component.translatable("gui.akaishi.reactor.energy_output_hint");
