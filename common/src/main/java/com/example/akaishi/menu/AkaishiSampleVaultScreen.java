 ...
 */
public class AkaishiSampleVaultScreen extends AbstractContainerScreen<AkaishiSampleVaultMenu> {
    ...
    public AkaishiSampleVaultScreen(AkaishiSampleVaultMenu menu, Inventory inv, Component title) {
