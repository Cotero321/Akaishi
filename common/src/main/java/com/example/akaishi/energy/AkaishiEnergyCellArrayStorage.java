 ...
 */
public class AkaishiEnergyCellArrayStorage implements IEnergyStorage {

    private final IEnergyType type;
    private final Supplier<List<IEnergyStorage>> memberSupplier;

    public AkaishiEnergyCellArrayStorage(IEnergyType type, Supplier<List<IEnergyStorage>> memberSupplier) {
        this.type = type;
