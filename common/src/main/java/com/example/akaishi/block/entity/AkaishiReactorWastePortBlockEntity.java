 ...
 * NBT 持久化缓冲罐与控制器坐标。
 */
public class AkaishiReactorWastePortBlockEntity extends BlockEntity implements IFluidPipeDevice, IDataCarrier {
    ...
    public AkaishiReactorWastePortBlockEntity(BlockPos pos, BlockState state) {
    ...
    public static void serverTick(Level level, BlockPos pos, BlockState state, AkaishiReactorWastePortBlockEntity be) {
        be.tickServer();
    }
