...
public class AkaishiGeneAnalyzerBlockEntity extends BlockEntity implements
    ...
    public AkaishiGeneAnalyzerBlockEntity(BlockPos pos, BlockState state) {
        ...
        this.inventory = new SimpleContainer(SLOT_COUNT) {
            ...
            public void setChanged() {
                super.setChanged();
                AkaishiGeneAnalyzerBlockEntity.this.setChanged();
            }
        };
        this.data = new SimpleContainerData(DATA_SLOTS);
    }

    public static void serverTick(Level level, BlockPos pos, BlockState state, AkaishiGeneAnalyzerBlockEntity be) {
        be.tickServer();
    }
    ...
    private void tickServer() {
        ...
        if (canProcess()) {
            ...
            if (progress >= ModConfig.geneAnalyzerProcessTicks) {
                ...
                if (level.random.nextFloat() < successRate(AkaishiLifeSampleItem.getPurity(sample))) {
    ...
    private boolean canProcess() {
        ...
        if (input.isEmpty() || !(input.getItem() instanceof AkaishiLifeSampleItem)
    ...
    public Component getDisplayName() {
        return Component.translatable("block.akaishi.akaishi_gene_analyzer");
    }

    @Override
    public AbstractContainerMenu createMenu(int id, Inventory inv, Player player) {
        return new AkaishiGeneAnalyzerMenu(id, inv, this);
    }
