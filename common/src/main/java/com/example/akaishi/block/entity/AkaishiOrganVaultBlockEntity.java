 ...
 */
public class AkaishiOrganVaultBlockEntity extends BlockEntity implements
    ...
    public AkaishiOrganVaultBlockEntity(BlockPos pos, BlockState state) {
        ...
        this.inventory = new SimpleContainer(SLOT_COUNT) {
            ...
            public void setChanged() {
                super.setChanged();
                AkaishiOrganVaultBlockEntity.this.setChanged();
            }
        };
        this.data = new SimpleContainerData(DATA_SLOTS);
    }

    public static void serverTick(Level level, BlockPos pos, BlockState state, AkaishiOrganVaultBlockEntity be) {
        be.tickServer();
    }
    ...
    public String getVaultNameKey() {
        return "block.akaishi.akaishi_organ_vault";
    }
    ...
    public Component getDisplayName() {
        return Component.translatable("block.akaishi.akaishi_organ_vault");
    }

    @Override
    public AbstractContainerMenu createMenu(int id, Inventory inv, Player player) {
        return new AkaishiOrganVaultMenu(id, inv, this);
    }
