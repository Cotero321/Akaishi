 ...
 * 容量/速率按等级区分（初级/中级/高级）。
 */
public class AkaishiPortableEnergyCell extends Item {
    ...
    public AkaishiPortableEnergyCell(PortableCellTier tier, Properties properties) {
        super(properties);
        this.tier = tier;
    }
    ...
    public static boolean isPortableCell(ItemStack stack) {
        return stack.getItem() instanceof AkaishiPortableEnergyCell;
    }

    /** 返回便携单元的等级，非便携单元返回 null */
    public static PortableCellTier tierOf(ItemStack stack) {
        return stack.getItem() instanceof AkaishiPortableEnergyCell cell ? cell.tier : null;
    }
    ...
    public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("gui.akaishi.portable_cell.hint"));
    }
}
