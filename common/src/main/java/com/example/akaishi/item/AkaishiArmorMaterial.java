 ...
 */
public final class AkaishiArmorMaterial {
    ...
    public static final ArmorMaterial MATERIAL = new ArmorMaterial() {
        ...
        public Ingredient getRepairIngredient() {
            return Ingredient.of(ModItems.akaishiIngot.get());
        }

        @Override
        public String getName() {
            // 返回带命名空间的名字，使 Forge 默认 getArmorTexture 定位到
            // akaishi:textures/models/armor/akaishi_layer_1/2.png
            return AkaishiMod.MOD_ID + ":akaishi";
        }
