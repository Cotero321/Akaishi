 ...
 */
public class ChishiLifeActivatorScreen extends AbstractContainerScreen<ChishiLifeActivatorMenu> {
    ...
    public ChishiLifeActivatorScreen(ChishiLifeActivatorMenu menu, Inventory inv, Component title) {
    ...
    protected void renderBg(GuiGraphics gui, float partialTick, int mouseX, int mouseY) {
        ...
        drawBar(gui, x, y + IN_Y, "gui.template_mod.activator.in",
                menu.getInAmount(), menu.getInMax(), 0xFF809070);
        drawBar(gui, x, y + OUT_Y, "gui.template_mod.activator.out",
                menu.getOutAmount(), menu.getOutMax(), 0xFF50E0B0);
        drawBar(gui, x, y + LIFE_Y, "gui.template_mod.life.short",
                menu.getLifeEnergy(), menu.getLifeMax(), 0xFF40E0C0);
        drawBar(gui, x, y + PROCESSED_Y, "gui.template_mod.activator.processed",
    ...
    protected void renderTooltip(GuiGraphics gui, int mouseX, int mouseY) {
        ...
        if (isHovering(TRACK_X, IN_Y, TRACK_W, BAR_H, mouseX, mouseY)) {
            gui.renderTooltip(this.font, Component.translatable("gui.template_mod.activator.in_tip",
            ...
            gui.renderTooltip(this.font, Component.translatable("gui.template_mod.activator.out_tip",
            ...
            gui.renderTooltip(this.font, Component.translatable("gui.template_mod.life",
            ...
            gui.renderTooltip(this.font, Component.translatable("gui.template_mod.activator.processed_tip",
