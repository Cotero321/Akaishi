 ...
 * 数据来自 {@link ChishiCultivatorMenu} 的 ContainerData（模式 + 进度）。
 */
public class ChishiCultivatorScreen extends AbstractContainerScreen<ChishiCultivatorMenu> {
    ...
    public ChishiCultivatorScreen(ChishiCultivatorMenu menu, Inventory inv, Component title) {
    ...
    protected void renderBg(GuiGraphics gui, float partialTick, int mouseX, int mouseY) {
        ...
        int color = mode == ChishiCultivatorBlockEntity.MODE_UPGRADE ? 0xFFFFD030 : 0xFF40E0D0;
    ...
    protected void renderLabels(GuiGraphics gui, int mouseX, int mouseY) {
        ...
        Component modeText = switch (mode) {
            case ChishiCultivatorBlockEntity.MODE_PURIFY ->
                    Component.translatable("gui.template_mod.cultivator.purify");
            case ChishiCultivatorBlockEntity.MODE_UPGRADE ->
                    Component.translatable("gui.template_mod.cultivator.upgrade");
            default -> Component.translatable("gui.template_mod.cultivator.idle");
        };
    ...
    public void render(GuiGraphics gui, int mouseX, int mouseY, float partialTick) {
        ...
        if (isHovering(PROGRESS_X, PROGRESS_Y, PROGRESS_W, PROGRESS_H, mouseX, mouseY)) {
            ...
            Component tip = mode == ChishiCultivatorBlockEntity.MODE_PURIFY
                    ? Component.translatable("gui.template_mod.cultivator.purify_tip", menu.getProgress(), rate)
                    : Component.translatable("gui.template_mod.cultivator.upgrade_tip", menu.getProgress(), rate);
