 ...
 * 能量与进度数值使用 M/K 缩写显示。
 */
public class ChishiEnergyAggregatorScreen extends AbstractContainerScreen<ChishiEnergyAggregatorMenu> {
    ...
    protected void renderLabels(GuiGraphics gui, int mouseX, int mouseY) {
        ...
        gui.drawString(this.font,
                Component.translatable("gui.template_mod.craft_times",
                        menu.getEnergy() / cost),
