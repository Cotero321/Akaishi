 ...
 */
public class ChishiEnergyCellScreen extends AbstractContainerScreen<ChishiEnergyCellMenu> {
    ...
    public ChishiEnergyCellScreen(ChishiEnergyCellMenu menu, Inventory inv, Component title) {
    ...
    public void render(GuiGraphics gui, int mouseX, int mouseY, float partialTick) {
        ...
        if (isHovering(CELL_SLOT_X, CELL_SLOT_Y, 18, 18, mouseX, mouseY)) {
            gui.renderTooltip(this.font,
                    Component.translatable("gui.template_mod.cell.portable", formatEnergy(menu.getCellEnergy()), formatEnergy(menu.getCellMaxEnergy())),
                    mouseX, mouseY);
        }
    }
}
