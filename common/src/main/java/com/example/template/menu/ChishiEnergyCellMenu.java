 ...
 */
public class ChishiEnergyCellMenu extends AbstractContainerMenu {

    private final ContainerData data;
    /** 便携单元充能槽容器 */
    private final Container cellSlot;

    public ChishiEnergyCellMenu(int id, Inventory playerInv, Container cellSlot, ContainerData data) {
        ...
        this.addSlot(new Slot(cellSlot, 0, 150, 44) {
            ...
            public boolean mayPlace(ItemStack stack) {
                return ChishiPortableEnergyCell.isPortableCell(stack);
            }
        });
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            } else if (ChishiPortableEnergyCell.isPortableCell(stack)) {
                // 背包中的便携单元 → 充能槽
    ...
    public static ChishiEnergyCellMenu emptyMenu(int id, Inventory inv) {
        return new ChishiEnergyCellMenu(id, inv, new SimpleContainer(1), new net.minecraft.world.inventory.SimpleContainerData(8));
    }
}
