 ...
 * 数据来自 {@link ChishiFluidTankMenu} 的 ContainerData。
 */
public class ChishiFluidTankScreen extends AbstractContainerScreen<ChishiFluidTankMenu> {
    ...
    public ChishiFluidTankScreen(ChishiFluidTankMenu menu, Inventory inv, Component title) {
