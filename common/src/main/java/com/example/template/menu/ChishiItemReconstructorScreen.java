 ...
 */
public class ChishiItemReconstructorScreen extends AbstractContainerScreen<ChishiItemReconstructorMenu> {
    ...
    public ChishiItemReconstructorScreen(ChishiItemReconstructorMenu menu, Inventory inv, Component title) {
    ...
    protected void renderLabels(GuiGraphics gui, int mouseX, int mouseY) {
        ...
        gui.drawString(this.font, Component.translatable("gui.template_mod.reconstructor.input"), 26, LABEL_Y, TEXT, false);
        gui.drawString(this.font, Component.translatable("gui.template_mod.reconstructor.crystal"), 62, LABEL_Y, TEXT, false);
        gui.drawString(this.font, Component.translatable("gui.template_mod.reconstructor.output"), 98, LABEL_Y, TEXT, false);
    }
    ...
    protected void renderTooltip(GuiGraphics gui, int mouseX, int mouseY) {
        ...
        if (isHovering(20, ENERGY_Y, 136, BAR_H, mouseX, mouseY)) {
            ...
            gui.renderTooltip(this.font, Component.translatable("gui.template_mod.reconstructor.progress_tip",
