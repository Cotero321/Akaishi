...
import com.example.template.menu.ChishiSurgeryMenu;
 ...
 * 槽位：0=器官输入，1=固态物。
 */
public class ChishiSurgeryBlockEntity extends BlockEntity implements
    ...
    public ChishiSurgeryBlockEntity(BlockPos pos, BlockState state) {
        ...
        this.inventory = new SimpleContainer(SLOT_COUNT) {
            ...
            public void setChanged() {
                super.setChanged();
                ChishiSurgeryBlockEntity.this.setChanged();
            }
        };
        this.data = new SimpleContainerData(DATA_SLOTS);
    }

    public static void serverTick(Level level, BlockPos pos, BlockState state, ChishiSurgeryBlockEntity be) {
        be.tickServer();
    }
    ...
    private boolean isPlayerStillInMenu(Player player) {
        return !player.isDeadOrDying()
                && player.containerMenu instanceof ChishiSurgeryMenu menu
    ...
    private boolean hasResources(int solid, long lifeCost) {
        ...
        return solidStack.is(ModItems.chishiLifeEssenceSolid.get())
    ...
    public Component getDisplayName() {
        return Component.translatable("block.template_mod.chishi_surgery");
    }
    ...
    public AbstractContainerMenu createMenu(int id, Inventory inv, Player player) {
        ...
        return new ChishiSurgeryMenu(id, inv, this);
    }
