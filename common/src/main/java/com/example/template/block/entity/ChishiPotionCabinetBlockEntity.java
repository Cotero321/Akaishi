...
import com.example.template.menu.ChishiPotionCabinetMenu;
 ...
 */
public class ChishiPotionCabinetBlockEntity extends BlockEntity implements
    ...
    public ChishiPotionCabinetBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CHISHI_POTION_CABINET.get(), pos, state);
        this.inventory = new SimpleContainer(CABINET_SLOTS) {
            @Override
            public void setChanged() {
                super.setChanged();
                ChishiPotionCabinetBlockEntity.this.setChanged();
            }
        };
    }

    public static void serverTick(Level level, BlockPos pos, BlockState state, ChishiPotionCabinetBlockEntity be) {
        be.tickServer();
    }
    ...
    public String getVaultNameKey() {
        return "block.template_mod.chishi_potion_cabinet";
    }
    ...
    public Component getDisplayName() {
        return Component.translatable("block.template_mod.chishi_potion_cabinet");
    }

    @Override
    public AbstractContainerMenu createMenu(int id, Inventory inv, Player player) {
        return new ChishiPotionCabinetMenu(id, inv, this);
    }
