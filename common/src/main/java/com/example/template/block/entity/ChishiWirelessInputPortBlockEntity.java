 ...
 */
public class ChishiWirelessInputPortBlockEntity extends BlockEntity implements IEnergyProvider, ExtendedMenuProvider, IDataCarrier, IWirelessPortHost {
    ...
    public ChishiWirelessInputPortBlockEntity(BlockPos pos, BlockState state) {
    ...
    public static void serverTick(Level level, BlockPos pos, BlockState state, ChishiWirelessInputPortBlockEntity be) {
        be.tickServer();
    }
    ...
    public Component getDisplayName() {
        return Component.translatable("block.template_mod.chishi_wireless_input_port");
    }
