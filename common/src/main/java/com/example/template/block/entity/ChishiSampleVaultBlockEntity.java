...
import com.example.template.menu.ChishiSampleVaultMenu;
 ...
 */
public class ChishiSampleVaultBlockEntity extends BlockEntity implements
    ...
    public ChishiSampleVaultBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CHISHI_SAMPLE_VAULT.get(), pos, state);
        this.inventory = new SimpleContainer(SAMPLE_SLOTS) {
            @Override
            public void setChanged() {
                super.setChanged();
                ChishiSampleVaultBlockEntity.this.setChanged();
            }
        };
    }

    public static void serverTick(Level level, BlockPos pos, BlockState state, ChishiSampleVaultBlockEntity be) {
        be.tickServer();
    }
    ...
    public String getVaultNameKey() {
        return "block.template_mod.chishi_sample_vault";
    }
    ...
    public Component getDisplayName() {
        return Component.translatable("block.template_mod.chishi_sample_vault");
    }

    @Override
    public AbstractContainerMenu createMenu(int id, Inventory inv, Player player) {
        return new ChishiSampleVaultMenu(id, inv, this);
    }
