 ...
 */
public final class ChishiUpgradeHelper {

    public static final String TAG = "ChishiGear";
    ...
    private ChishiUpgradeHelper() {
    }

    /** 基础升级类型（打造器分配） */
    public enum UpgradeType {
        ATTACK_SPEED(Attributes.ATTACK_SPEED, 0.15, TAG_ATTACK_SPEED, "gui.template_mod.tooltip.attack_speed", "gui.template_mod.upgrade.attack_speed"),
        ATTACK_DAMAGE(Attributes.ATTACK_DAMAGE, 1.0, TAG_ATTACK_DAMAGE, "gui.template_mod.tooltip.attack_damage", "gui.template_mod.upgrade.attack_damage"),
        EFFICIENCY(null, 20.0, TAG_EFFICIENCY, "gui.template_mod.tooltip.efficiency", "gui.template_mod.upgrade.efficiency"),
        MAX_HEALTH(Attributes.MAX_HEALTH, 2.0, TAG_MAX_HEALTH, "gui.template_mod.tooltip.max_health", "gui.template_mod.upgrade.max_health"),
        ARMOR(Attributes.ARMOR, 1.0, TAG_ARMOR, "gui.template_mod.tooltip.armor", "gui.template_mod.upgrade.armor"),
        TOUGHNESS(Attributes.ARMOR_TOUGHNESS, 1.0, TAG_TOUGHNESS, "gui.template_mod.tooltip.toughness", "gui.template_mod.upgrade.toughness");
    ...
    public enum SpecialAbility {
        ...
        LIFESTEAL(null, null, 3, TAG_ABILITY_LIFESTEAL, "gui.template_mod.tooltip.ability.lifesteal", "gui.template_mod.upgrade.ability_lifesteal"),
        KNOCKBACK(null, null, 3, TAG_ABILITY_KNOCKBACK, "gui.template_mod.tooltip.ability.knockback", "gui.template_mod.upgrade.ability_knockback"),
        SPEED(null, null, 3, TAG_ABILITY_SPEED, "gui.template_mod.tooltip.ability.speed", "gui.template_mod.upgrade.ability_speed"),
        FIRE_RESIST(null, null, 3, TAG_ABILITY_FIRE_RESIST, "gui.template_mod.tooltip.ability.fire_resist", "gui.template_mod.upgrade.ability_fire"),
        BLAST_PROTECT(null, null, 3, TAG_ABILITY_BLAST_PROTECT, "gui.template_mod.tooltip.ability.blast_protect", "gui.template_mod.upgrade.ability_blast"),
        FALL_PROTECT(null, null, 3, TAG_ABILITY_FALL_PROTECT, "gui.template_mod.tooltip.ability.fall_protect", "gui.template_mod.upgrade.ability_fall"),
        // 部位专属能力：仅对应护甲部位可升级，只能升级 1 次
        HASTE(null, EquipmentSlot.HEAD, 1, TAG_ABILITY_HASTE, "gui.template_mod.tooltip.ability.haste", "gui.template_mod.upgrade.ability_haste"),
        WATER_BREATHING(null, EquipmentSlot.HEAD, 1, TAG_ABILITY_WATER_BREATHING, "gui.template_mod.tooltip.ability.water_breathing", "gui.template_mod.upgrade.ability_water_breathing"),
        RESISTANCE(null, EquipmentSlot.CHEST, 1, TAG_ABILITY_RESISTANCE, "gui.template_mod.tooltip.ability.resistance", "gui.template_mod.upgrade.ability_resistance"),
        HIT_REGEN(null, EquipmentSlot.CHEST, 1, TAG_ABILITY_HIT_REGEN, "gui.template_mod.tooltip.ability.hit_regen", "gui.template_mod.upgrade.ability_hit_regen"),
        JUMP_BOOST(null, EquipmentSlot.LEGS, 1, TAG_ABILITY_JUMP_BOOST, "gui.template_mod.tooltip.ability.jump_boost", "gui.template_mod.upgrade.ability_jump_boost"),
        SWIM_SPEED(null, EquipmentSlot.LEGS, 1, TAG_ABILITY_SWIM_SPEED, "gui.template_mod.tooltip.ability.swim_speed", "gui.template_mod.upgrade.ability_swim_speed"),
        SLOW_FALLING(null, EquipmentSlot.FEET, 1, TAG_ABILITY_SLOW_FALLING, "gui.template_mod.tooltip.ability.slow_falling", "gui.template_mod.upgrade.ability_slow_falling"),
        BOOTS_SPEED(null, EquipmentSlot.FEET, 1, TAG_ABILITY_BOOTS_SPEED, "gui.template_mod.tooltip.ability.boots_speed", "gui.template_mod.upgrade.ability_boots_speed"),
        // 工具/剑专属能力
        AREA_BREAK(GearKind.TOOL, null, 1, TAG_ABILITY_AREA_BREAK, "gui.template_mod.tooltip.ability.area_break", "gui.template_mod.upgrade.ability_area_break"),
        DROP_ESSENCE(GearKind.SWORD, null, 3, TAG_ABILITY_DROP_ESSENCE, "gui.template_mod.tooltip.ability.drop_essence", "gui.template_mod.upgrade.ability_drop_essence");
        ...
        public boolean isApplicable(ItemStack gear) {
            if (kind == GearKind.TOOL) {
                return gear.getItem() instanceof ChishiShovelItem
                        || gear.getItem() instanceof ChishiAxeItem
                        || gear.getItem() instanceof ChishiPickaxeItem;
            }
            if (kind == GearKind.SWORD) {
                return gear.getItem() instanceof ChishiSwordItem;
            }
            if (slot == null) {
                return true;
            }
    ...
    /** 是否为赤石装备（携带升级标签） */
    public static boolean isChishiGear(ItemStack stack) {
        return stack.getTagElement(TAG) != null;
    }

    /** 物品是否为赤石装备（护甲/剑/工具） */
    public static boolean isChishiEquipment(ItemStack stack) {
        return stack.getItem() instanceof ChishiArmorItem || stack.getItem() instanceof ChishiSwordItem
                || stack.getItem() instanceof ChishiShovelItem || stack.getItem() instanceof ChishiAxeItem
                || stack.getItem() instanceof ChishiPickaxeItem;
    }

    /** 是否支持效率升级的挖掘类工具（铲/斧/镐） */
    public static boolean isEfficiencyTool(ItemStack stack) {
        return stack.getItem() instanceof ChishiShovelItem
                || stack.getItem() instanceof ChishiAxeItem
                || stack.getItem() instanceof ChishiPickaxeItem;
    }
    ...
    public static void ensureGear(ItemStack stack) {
        if (isChishiEquipment(stack) && !isChishiGear(stack)) {
            initGear(stack);
        }
    }
    ...
    public static boolean applyAbility(ItemStack stack, SpecialAbility ability) {
        if (stack.isEmpty() || !isChishiGear(stack)) {
            return false;
        }
        CompoundTag tag = gearTag(stack);
    ...
    public static void appendTooltip(ItemStack stack, List<Component> tooltip) {
        ...
        tooltip.add(Component.translatable("gui.template_mod.tooltip.slots", getSlots(stack)));
    }
