 ...
 */
public abstract class ChishiCurioItem extends Item implements ICurioItem {
    ...
    public ChishiCurioItem(Properties properties, long capacity) {
        super(properties);
    ...
    private static long pullFromInventory(Player player, long amount) {
        ...
        for (ItemStack inv : player.getInventory().items) {
            ...
            if (inv.getItem() instanceof ChishiPortableEnergyCell cell) {
