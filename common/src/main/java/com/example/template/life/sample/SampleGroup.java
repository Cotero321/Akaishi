...
public enum SampleGroup {
    ...
    /** 温血生物（动物/水生） */
    WARM_BLOODED("warm_blooded", 45, 85, 75, 95, 0.8, "life.template_mod.sample_group.warm_blooded"),
    /** 亡灵生物（僵尸/骷髅等） */
    UNDEAD("undead", 55, 70, 60, 85, 1.0, "life.template_mod.sample_group.undead"),
    /** 爆炸性生物（苦力怕） */
    EXPLOSIVE("explosive", 60, 55, 45, 70, 1.1, "life.template_mod.sample_group.explosive"),
    /** 末影生物（末影人/末影螨/潜影贝） */
    ENDER("ender", 70, 40, 35, 60, 1.3, "life.template_mod.sample_group.ender"),
    /** 龙族（末影龙，顶级样本） */
    DRAGON("dragon", 90, 25, 25, 50, 1.6, "life.template_mod.sample_group.dragon");
